        ...
        <Container>
          ...
          <div className="mt-8 flex gap-4 p-6 bg-slate-50 border border-slate-200 rounded-2xl items-start">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 leading-relaxed">A aplicação pode ocorrer fora do consultório como extensão controlada do acompanhamento. O WhatsApp é the meio de envio — a execução ocorre em ambiente seguro e controlado.</p>
            </div>
          </div>
        </Container>
      </Section>
