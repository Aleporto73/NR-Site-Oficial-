          ...
          <section className="relative pt-20 pb-24 md:pt-32 md:pb-32 overflow-hidden">
            ...
            <Container className="relative">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <h2 className="text-xl text-slate-600 mb-8 leading-relaxed max-w-2xl mx-auto">
          ...
          <Section className="bg-white">
            <Container>
              ...
              <div className="flex justify-center">
                <div className="w-full max-w-xl bg-white p-8 md:p-12 rounded-3xl shadow-xl border border-slate-100 text-center">
                  <h3 className="text-2xl font-extrabold text-slate-900 mb-2">Plano Profissional — Uso Clínico Individual</h3>
                  <p className="text-slate-600 mb-8 leading-relaxed">Licença anual para aplicação clínica contínua, com aprendentes ilimitados em um único dispositivo.</p>
                  
                  <div className="mb-10">
                    <span className="text-5xl font-black text-blue-900">R$ 147,00</span>
                    <span className="text-slate-500 text-xl font-medium ml-2">/ ano</span>
                    <p className="text-sm text-slate-500 mt-2 font-semibold">Licença profissional individual · 1 dispositivo ativo</p>
                  </div>

                  <div className="text-left mb-10">
                    <h4 className="text-slate-900 font-bold mb-6 text-lg border-b border-slate-100 pb-2">O que está incluído</h4>
                    <ul className="space-y-6">
                      <li className="flex items-start gap-3">
                        <CheckCircle2 className="w-6 h-6 text-teal-500 mt-0.5 flex-shrink-0" />
                        <div>
                          <span className="text-slate-900 font-bold block">Aprendentes ilimitados</span>
                          <span className="text-slate-600 text-sm">Sem limite de crianças, avaliações ou sessões clínicas.</span>
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 className="w-6 h-6 text-teal-500 mt-0.5 flex-shrink-0" />
                        <div>
                          <span className="text-slate-900 font-bold block">6 testes cognitivos funcionais</span>
                          <span className="text-slate-600 text-sm">Rastreios padronizados com precisão temporal em milissegundos.</span>
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 className="w-6 h-6 text-teal-500 mt-0.5 flex-shrink-0" />
                        <div>
                          <span className="text-slate-900 font-bold block">Faixa etária: 6 a 14 anos</span>
                          <span className="text-slate-600 text-sm">Indicado para uso clínico e educacional.</span>
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 className="w-6 h-6 text-teal-500 mt-0.5 flex-shrink-0" />
                        <div>
                          <span className="text-slate-900 font-bold block">Relatório técnico para o profissional</span>
                          <span className="text-slate-600 text-sm">Dados estruturados para análise e tomada de decisão clínica.</span>
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 className="w-6 h-6 text-teal-500 mt-0.5 flex-shrink-0" />
                        <div>
                          <span className="text-slate-900 font-bold block">Relatório simplificado para pais ou responsáveis</span>
                          <span className="text-slate-600 text-sm">Linguagem clara, objetiva e acessível.</span>
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 className="w-6 h-6 text-teal-500 mt-0.5 flex-shrink-0" />
                        <div>
                          <span className="text-slate-900 font-bold block">Aplicação remota por link seguro</span>
                          <span className="text-slate-600 text-sm">Sem instalação no dispositivo do aprendiz.</span>
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 className="w-6 h-6 text-teal-500 mt-0.5 flex-shrink-0" />
                        <div>
                          <span className="text-slate-900 font-bold block">Licença vinculada a 1 dispositivo ativo</span>
                          <span className="text-slate-600 text-sm">Uso ilimitado em volume, restrito a um único dispositivo por licença.</span>
                        </div>
                      </li>
                    </ul>
                  </div>

                  <Button onClick={handlePurchase} className="w-full text-xl py-5 mb-6 font-bold tracking-tight">
                    Ativar licença anual
                  </Button>

                  <div className="max-w-sm mx-auto">
                    <p className="text-[10px] text-slate-400 leading-normal uppercase font-bold tracking-wider">
                      Compra imediata · 1 dispositivo ativo · aprendentes ilimitados. <br />
                      Reembolso disponível por 7 dias, conforme política.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-900 rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden">
                ...
                <div className="flex justify-center relative z-10">
                  <Button onClick={handlePurchase} variant="secondary" className="bg-teal-500 text-white hover:bg-teal-600 border-none text-lg px-8">
                    Reembolso disponível por 7 dias · 1 dispositivo ativo
                  </Button>
                </div>
              </div>
            </Container>
          ...
          <footer className="bg-slate-50 pt-16 pb-8 border-t border-slate-200 text-sm">
            <Container>
              ...
              <div className="pt-8 border-t border-slate-200 text-center md:text-left flex flex-col md:flex-row justify-between items-center text-slate-400">
                ...
                <p className="mt-2 md:mt-0">Desenvolvido com rigor científico pela <a href="https://psiform.com.br" target="_blank" rel="noopener noreferrer" className="hover:text-blue-900 transition-colors underline underline-offset-4">Psiform</a>.</p>
              </div>
            </Container>
          </footer>
        </>
